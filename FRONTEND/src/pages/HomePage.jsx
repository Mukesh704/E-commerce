...
import heroImage from '../assets/images/hero-bg.jpg'; // Make sure you have this image

// A list of Tailwind CSS background colors to cycle through for the categories
